...
description: ""
canonical: "https://getmanov.com/b2b-seo-links"
---
...
Оценка эффективности построения ссылок требует анализа реферального трафика и качества ссылающихся доменов. [Для этой цели можете использовать такой инструмент как SEMRush](http://getmanov.com/b2b-seo-tools).  
